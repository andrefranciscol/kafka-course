...
public class FavouriteColorApp {
    public static void main(String[] args) {
        ...
        KStream<String, String> favoriteColorsCount = stream
                // 2 - map values to lowercase
                .mapValues(colour -> colour.toLowerCase())
                // 3 - filter admissible colors
                .filter((user_id, colour) -> Arrays.asList("blue", "green").contains(colour));
        ...
        favoriteColorsCount.to("favourite-colour-output");
